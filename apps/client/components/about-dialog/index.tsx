...
const AboutDialog = forwardRef<AboutDialogRef, AboutDialogProps>(
  ({ forceDark = false }, ref) => {
    ...
    if (isDesktop) {
      return (
        <Dialog aria-label="About Kolab" onOpenChange={setIsOpen} open={isOpen}>
          <DialogContent className={cn("max-w-2xl", forceDark && "dark")}>
            ...
            <div
              aria-label="Kolab application preview"
              className="relative aspect-[600/315]"
              role="img"
            >
              <Image
                alt="Kolab application interface preview"
    ...
    return (
      <Drawer aria-label="About Kolab" onOpenChange={setIsOpen} open={isOpen}>
        <DrawerContent>
          <DrawerHeader>
