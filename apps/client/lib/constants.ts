...
export const BASE_CLIENT_URL = IS_DEV_ENV
  ? "http://localhost:3000"
  : "https://Kolab.dulapahv.dev";
export const BASE_SERVER_URL = IS_DEV_ENV
  ? "http://localhost:3001"
  : "https://Kolab-server.dulapahv.dev";

export const STATUS_URL = "https://Kolab-status.dulapahv.dev";
...
export const SITE_NAME = "Kolab - Code Collaboration Platform";
export const SITE_DESCRIPTION =
  "Your collaborative coding space, reimagined. Code together now on Kolab, no sign-up required.";
...
export const LATENCY_TEST_DESCRIPTION =
  "Test your latency to the Kolab server.";
...
export const REPO_URL = "https://github.com/dulapahv/Kolab";
